...
class ChangeDecoder(nn.Module):
    def __init__(self, encoder_dims, channel_first, norm_layer, ssm_act_layer, mlp_act_layer, **kwargs):
        ...
        self.alpha41 = nn.Parameter(torch.tensor(0.5))  # Learnable weight
        ...
        self.alpha31 = nn.Parameter(torch.tensor(0.5))  # Learnable weight
    ...
    def forward(self, pre_features, post_features):
        ...
        #print('cat_input.shape=', cat_input.shape)
        #print('p42.shape=', p42.shape)
        ...
        p4 = self.alpha41*p41 + (1-self.alpha41)*p42
        ...
        p3 = self.alpha31*p31 + (1-self.alpha31)*p32
