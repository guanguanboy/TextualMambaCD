...
class ChangeDecoder(nn.Module):
    ...
    def forward(self, pre_features, post_features):
        ...
        p22 = self.dim_convert21(torch.cat([pre_feat_2, post_feat_2], dim=1))

        p22 = self.at_layer_21(p22)
        ...
        p12 = self.dim_convert11(torch.cat([pre_feat_1, post_feat_1], dim=1))

        p12 = self.at_layer_21(p12)
