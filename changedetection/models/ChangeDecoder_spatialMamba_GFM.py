...
from MambaCD.changedetection.models.fuse import GFM
class ChangeDecoder(nn.Module):
    def __init__(self, encoder_dims, channel_first, norm_layer, ssm_act_layer, mlp_act_layer, **kwargs):
        ...
        self.gfm_layer_3 = GFM(in_channels=128) 
        self.gfm_layer_2 = GFM(in_channels=128) 
        self.gfm_layer_1 = GFM(in_channels=128) 

    def _upsample_add(self, x, y):
        _, _, H, W = y.size()
        return F.interpolate(x, size=(H, W), mode='bilinear') + y

    def _upsample_only(self, x, y):
        _, _, H, W = y.size()
    ...
    def forward(self, pre_features, post_features):
        ...
        p4_up = self._upsample_only(p4, p3)
        p3 = self.gfm_layer_3(p3, p4_up)
        ...
        p3_up = self._upsample_only(p3, p2)
        p2 = self.gfm_layer_2(p2, p3_up)
        ...
        p2_up = self._upsample_only(p2, p1)
        p1 = self.gfm_layer_1(p1, p2_up)
        return p1
