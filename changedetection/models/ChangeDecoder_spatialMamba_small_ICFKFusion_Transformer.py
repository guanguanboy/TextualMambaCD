...
class ChangeDecoder(nn.Module):
    ...
    def forward(self, pre_features, post_features):
        ...
        p41 = p41.permute(0,2,1)
        #print('p41 step 2:', p41.shape)

        p41 = self.at_layer_41(p41)
        ...
        p41 = p41.view(batch_size, chan_width, height, width)
        ...
        p31 = p31.flatten(2)
        p31 = p31.permute(0,2,1)
        p31 = self.at_layer_31(p31)
        p31 = p31.permute(0,2,1)
        p31 = p31.view(batch_size, chan_width, height, width)
